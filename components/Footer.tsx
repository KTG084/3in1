        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 mb-4 max-w-md">
              Revolutionizing STEM education through innovative 3-in-1
              transformable robots. Building the next generation of innovators
              and problem solvers.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://github.com/AdarshSharma24/3-in-1_Bot"
                target="_blank"
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Link
                href="https://github.com/AdarshSharma24/3-in-1_Bot/blob/main/README.md"
                className="block text-slate-400 hover:text-cyan-400 transition-colors duration-300"
              >
                Documentation
              </Link>
